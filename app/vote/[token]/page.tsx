  ...
  return (
    <main className="vt-page">
      ...
      <div className="vt-ribbon vt-ribbon-tl">
        <Image
          src="/images/voting/pitapojokkiriatas.png"
          alt=""
          fill
      ...
      <div className="vt-ribbon vt-ribbon-br">
        <Image
          src="/images/voting/pitapojokkananbawa.png"
          alt=""
          fill
          className="object-contain"
      ...
      {/* FLOWERS */}
      <div className="vt-flower vt-fl1">
        <Image
          src="/images/voting/bunga(1).png"
          alt=""
          width={60}
          height={60}
        />
      </div>
      <div className="vt-flower vt-fl2">
        <Image
          src="/images/voting/bunga(1).png"
          alt=""
          width={45}
      ...
      <div className="vt-flower vt-fl3">
        <Image
          src="/images/voting/bunga(1).png"
          alt=""
          width={50}
      ...
      <div className="vt-flower vt-fl4">
        <Image
          src="/images/voting/bunga(1).png"
          alt=""
          width={40}
      ...
      <div className="vt-content">
        <div className="vt-title-wrap">
          <Image
            src="/images/voting/tittlevoting.png"
            alt="Voting"
            width={500}
            height={150}
            className="vt-title-img"
            priority
          />
        </div>
          ...
          <div className="vt-scroll-inner hide-scrollbar">
            {loading ? (
              <div className="vt-status">
                ...
                <p className="text-yellow-900 font-bold animate-pulse">
              ...
              <div className="vt-status">
                ...
                <p className="text-yellow-900 font-bold text-xl md:text-2xl mt-4">
                  Pemberitahuan
                </p>
                <p className="text-yellow-900 font-medium leading-relaxed max-w-sm text-center">
                  {statusMessage || "Silakan coba scan ulang kembali ya."}
                </p>
              </div>
            ) : (
              <>
                {paginatedCandidates.map((candidate) => {
                  ...
                  return (
                    <div key={candidate.id} className="vt-card-row">
                      <div
                        className={`vt-card-wrap ${isSelected ? "vt-card-sel" : ""}`}
                      >
                        ...
                        <VotingCard
                          ...
                          name={candidate.name}
                          imageUrl={
                            candidate.imageUrl || "/images/voting/teratai.png"
                          }
                          onClick={() => setSelectedCandidateId(candidate.id)}
                          showVoteDecoration={false}
                        />
                      </div>
                    </div>
                  );
                ...
                {totalPages > 1 && (
                  <div className="vt-pagination">
                    <button
                      ...
                      className={`vt-page-btn ${currentPage === 0 ? "vt-page-btn-off" : "vt-page-btn-on"}`}
                    >
                      ‹
                    </button>
                    {Array.from({ length: totalPages }, (_, i) => (
                      <button
                        ...
                        className={`vt-page-dot ${currentPage === i ? "vt-page-dot-active" : ""}`}
                      >
                        {i + 1}
                      </button>
                    ))}
                    <button
                      ...
                      className={`vt-page-btn ${currentPage === totalPages - 1 ? "vt-page-btn-off" : "vt-page-btn-on"}`}
                    >
                      ›
                    </button>
                  </div>
                ...
                {candidates.length > 0 && (
                  <div className="vt-konfirmasi">
                    <button
                      ...
                      className={`vt-btn ${selectedCandidateId && !submitting ? "vt-btn-on" : "vt-btn-off"}`}
                    >
      ...
      {showConfirmModal && (
        <div className="vt-modal-overlay">
          ...
          <div className="vt-modal animate-fade-in-up">
            ...
            <p className="vt-modal-text">
              Apakah kamu yakin menyalurkan suara untuk kandidat ini?
              <br />
              <span className="vt-modal-warn">
                Pilihan otomatis tersimpan dan tidak dapat diubah kembali.
              </span>
            </p>
            <div className="vt-modal-acts">
              <button
                onClick={() => setShowConfirmModal(false)}
                className="vt-modal-cancel"
              >
                Cek Lagi
              </button>
              <button onClick={executeVote} className="vt-modal-ok">
                Yakin!
              </button>
            </div>
          </div>
      ...
      <style jsx global>{`
        ...
        .vt-page-btn-on:hover {
          background: rgba(92, 36, 8, 0.15);
          transform: scale(1.1);
        }
        .vt-page-btn-on:active {
          transform: scale(0.9);
        }
        .vt-page-btn-off {
          opacity: 0.3;
        ...
        .vt-page-dot:hover {
          background: rgba(92, 36, 8, 0.1);
        }
        .vt-page-dot-active {
          background: linear-gradient(to bottom, #6b1e06, #3a0600);
          color: #fff;
          border-color: #eab308;
        ...
        .vt-scroll {
          position: relative;
          width: 100%;
          background: linear-gradient(to bottom, #ef9e1e, #f7c063, #ef9e1e);
        ...
        .vt-card-sel {
          box-shadow: 0 0 40px rgba(255, 183, 3, 1);
        ...
        .vt-modal {
          ...
          width: 100%;
          max-width: 380px;
          background: linear-gradient(135deg, #f8d998, #e8b55d);
          border: 4px solid #5c2408;
          border-radius: 24px;
