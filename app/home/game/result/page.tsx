...
export default function GameResult() {
  ...
  return (
    <main className="relative w-full h-fit min-h-screen overflow-hidden bg-[url('/images/bg-motif.png')] bg-repeat bg-contain bg-[#9f0505]">
      ...
      <div className="relative w-fit h-fit mx-auto px-2 md:px-10 py-10 md:py-20 my-40 z-20 bg-amber-300 bg-linear-to-b from-[#EF9E1E] from-10% via-[#F7C063] via-50% to-[#EF9E1E] to-95%">
        ...
        <div className="relative w-full flex flex-col items-center justify-center z-30">
          <div className="w-[82vw] max-w-[860px] h-auto flex flex-col items-center justify-center gap-2 md:gap-3 lg:gap-4 pt-9 pb-3 md:pt-12 md:pb-4 md:px-8 relative">
            ...
            <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mt-4 md:mt-8">
              <Link href="/home/game">
                <button className="px-[clamp(16px,4vw,24px)] py-[clamp(8px,1vh,14px)] rounded-md md:rounded-lg font-bold text-[clamp(12px,2vw,16px)] tracking-wider uppercase transition-all duration-300 bg-amber-100/90 text-[#5e2b07] border-2 border-[#5e2b07] shadow-sm hover:bg-[#5e2b07] hover:text-yellow-100">
                  Main Lagi
                </button>
              </Link>

              <Link href="/home">
                <button className="px-[clamp(16px,4vw,24px)] py-[clamp(8px,1vh,14px)] rounded-md md:rounded-lg font-bold text-[clamp(12px,2vw,16px)] tracking-wider uppercase transition-all duration-300 bg-[#5e2b07] text-[#f4d499] border-2 border-[#3d1902] shadow-md hover:scale-105">
                  Kembali Ke Beranda
                </button>
              </Link>
            </div>
