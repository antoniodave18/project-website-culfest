      ...
      <div className="relative w-[80vw] mx-auto pt-10 md:pt-20 mb-20 bg-amber-300
        ...
        <div className="relative w-[calc(100%-5rem)] md:w-[calc(100%-20rem)] mx-auto my-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
              className="
      relative md:col-span-2 w-full rounded-xl px-3 md:px-6 py-3 md:py-4
      bg-[#253378] border-4 border-black/25
      shadow-[10px_10px_20px_rgba(0,0,0,0.5)]
    "
            >
              <p className="relative z-10 text-justify text-sm md:text-base lg:text-xl text-white font-bold tracking-wide mb-6 whitespace-pre-line">
                {detail.facility}
              </p>
            </div>
            ...
            <div
              className="
      relative w-full rounded-xl px-1 md:px-2 py-2 md:py-4
      bg-[#253378] border-4 border-black/25
      shadow-[10px_10px_20px_rgba(0,0,0,0.5)]
    "
            >
        
              <div className="relative flex flex-col items-center gap-1 w-full px-2 py-5 mt-2 md:mt-0
               border-4 rounded-lg border-[#ef9e1e] ">
                <div className="pointer-events-none absolute left-1/2 top-0 z-10 h-30 w-full -translate-x-1/2 -translate-y-1/2">
                  <Image
                    src="/images/jelajah/asrama/slug/keseruan-title.png"
                    alt="Title Banner"
                    fill
                    sizes="(max-width: 768px) 100vw, 80vw"
                    className="object-contain"
    ...
    "
            >
              ...
              >
                ...
                {gmapQuery ? (
                  <p className="mt-2 text-center text-xs md:text-sm font-semibold text-white">{gmapQuery}</p>
                ) : null}
              </Link>
