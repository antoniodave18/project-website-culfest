      ...
      <div className="relative z-2 w-full px-6 md:px-12 pt-20 md:pt-10 pb-6">
        <div className="flex justify-between items-start w-full">
          <div className="flex flex-col gap-3 max-w-[320px]">
            ...
            <p className="text-white/70 text-xs md:text-[11px] leading-relaxed">
              Jl. Bhinneka Tunggal Ika, Bulaksumur, Caturtunggal, Depok, Sleman,
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4 items-center">
            <a
              href="https://instagram.com/culfest_ugmr"
            ...
            <a
              href="https://youtube.com/@culfest15"
              aria-label="YouTube"
              className="text-white/70 hover:text-yellow-400 transition-colors"
            >
              <svg
            ...
            <a
              href="https://tiktok.com/@culfest_ugmr"
              aria-label="TikTok"
              className="text-white/70 hover:text-yellow-400 transition-colors"
            >
              <svg
