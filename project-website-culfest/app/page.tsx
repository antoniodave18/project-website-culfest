            ...
            <div className="flex justify-between items-start w-full">
              ...
              <div className="flex gap-16">
                <div className="flex flex-col gap-1">
                  ...
                  <a href="/about-event" className="text-white/80 text-[11px] hover:text-yellow-400 transition-colors">Asrama</a>
                  <a href="/about-event" className="text-white/80 text-[11px] hover:text-yellow-400 transition-colors">Ormada</a>
                  <a href="/game" className="text-white/80 text-[11px] hover:text-yellow-400 transition-colors">FestPlay</a>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-white/40 text-[10px] tracking-widest uppercase mb-1">Info</span>
                  <a href="/akun" className="text-white/80 text-[11px] hover:text-yellow-400 transition-colors">Contact Us</a>
                  <a href="/faq" className="text-white/80 text-[11px] hover:text-yellow-400 transition-colors">FAQ</a>
                </div>
              </div>
