...
export default function LandingPage() {
  ...
  const handleChestClick = () => {
    ...
    setTimeout(() => handleRevealScroll(), 700);
  };
  ...
  return (
    <main className="bg-black">
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div
          className="hidden absolute w-1/3 h-3/5 z-3 animate-sway transition-opacity duration-500 lg:block"
          style={{ opacity: bgChanged ? 0 : 1 }}
        >
          <Image
        ...
        <div
          className="hidden absolute top-0 right-0 w-1/3 h-3/5 z-3 animate-swayReverse transition-opacity duration-500 lg:block"
          style={{ opacity: bgChanged ? 0 : 1 }}
        >
          <Image
