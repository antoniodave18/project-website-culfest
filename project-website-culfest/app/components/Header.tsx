...
export default function Header() {
  ...
  return (
    <header
      ...
      style={{
        background:
          "linear-gradient(to bottom, #1a0500 0%, #2d0800 60%, #3d0a00cc 100%)",
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, #c8860a, #ffd46c, #c8860a, transparent)",
        }}
      />
              ...
              >
                ...
                {isActive && (
                  <span
                    ...
                    style={{
                      background:
                        "linear-gradient(to right, transparent, #ffd46c, transparent)",
                    }}
                  />
                )}
              </Link>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, #c8860a40, #ffd46c80, #c8860a40, transparent)",
        }}
      />
    </header>
  );
